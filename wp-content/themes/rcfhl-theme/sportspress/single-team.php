								...
								<div class="col-12 next-last-game">
									<div class="next-last-game-wrap">
										...
										<div class="row last-game">
											<div class="col-12">
												<?php echo do_shortcode("[event_blocks id='36' team='302' league='2' season='3' status='any' date='range' date_past='7' date_future='0' date_relative='1' day='' show_all_events_link='0' align='none']"); ?>
											</div>
										</div>
										<div class="row next-game">
											<div class="col-12">
												<?php echo do_shortcode("[event_blocks id='36' team='302' league='2' season='3' status='any' date='range' date_past='0' date_future='7' date_relative='1' day='' show_all_events_link='0' align='none']"); ?>
											</div>
										</div>
									</div>
								</div>
								<div class="col-12 full-schedule">
									<?php echo do_shortcode("[event_list id='36' title='' team='302' league='2' season='3' status='any' date='0' date_from='default' date_to='default' date_past='' date_future='' date_relative='0' day='' number='10' order='default' columns='event,teams,time' show_all_events_link='0' align='none']"); ?>
								</div>
							</div>
						</div>
					</div>
